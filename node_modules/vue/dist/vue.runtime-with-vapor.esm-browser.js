...
var DynamicFragment = class extends VaporFragment {
	constructor(anchorLabel, keyed = false, locate = true) {
		...
		this.hydrate = (isEmpty = false) => {
			...
			if (this.anchorLabel === "slot" && (!forwardedSlot || isValidSlot && !isInSlotFallback) || this.anchorLabel === "if" && isArray(this.nodes)) if (isComment(currentHydrationNode, "]")) {
				this.anchor = currentHydrationNode;
				advanceHydrationNode(currentHydrationNode);
				return;
			...
			queuePostFlushCb(() => {
				parentNode.insertBefore(this.anchor = /* @__PURE__ */ createComment(this.anchorLabel), nextNode);
			});
		};
		this.keyed = keyed;
		if (isHydrating$1) {
